 ...
 * Name: Bart de Haan
 *
 * This file is adapted from aodv-rqueue.h. We only changed the AODV tags so
 * it works with the LEACH module.
 * Link: https://www.nsnam.org/doxygen/aodv-rqueue_8h.html
 */
#ifndef LEACH_RQUEUE_H
#define LEACH_RQUEUE_H
