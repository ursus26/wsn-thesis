 ...
 * Name: Bart de Haan
 *
 * This file is adapted from aodv-rtable.h. We changed the AODV types to LEACH
 * types.
 * Source: https://www.nsnam.org/doxygen/aodv-rtable_8h.html
 */
#ifndef LEACH_RTABLE_H
#define LEACH_RTABLE_H
