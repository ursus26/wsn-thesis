 ...
 * Name: Bart de Haan
 *
 * This file is adapted from aodv-rqueue.cc. We only changed the AODV tags so
 * it works with the LEACH module.
 * Link: https://www.nsnam.org/doxygen/aodv-rqueue_8cc.html
 */
...
NS_LOG_COMPONENT_DEFINE ("LeachRequestQueue");
